		  	...
		  	<div class="col-xs-12 col-sm-12">
		  				...
		  				<tbody>
		  					<?php foreach($done as $item): ?>
		  						<tr>
		  							...
		  							<td><span class="label label-lg label-success"><i class="ace-icon fa fa-check"></i></span></td>
		  						</tr>
		  					<?php endforeach; ?>
  						</tbody>
  					</table>
		  		...
		  		<?php if ($not_done): ?>
		  			<table id="simple-table" class="table table-striped table-bordered table-hover">
		  				...
		  				<tbody>
		  					<?php foreach($not_done as $item): ?>
		  						<tr>
		  							<td><?php echo $item->user_id; ?></td>
		  							<td><?php echo $item->name; ?></td>
		  							<td><?php echo $item->position; ?></td>
		  							<td><span class="label label-lg label-danger"><i class="ace-icon fa fa-close"></i></span></td>
		  						</tr>
		  					<?php endforeach; ?>
  						</tbody>
  					</table>
