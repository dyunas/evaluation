	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/questionnaire/executive'); ?>">For Executive</a>
			</li>
			<li class="active">
			  New Question
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/questionnaire/executive/insert'), 'id="question-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="question" name="question" class="col-xs-10 col-sm-10" maxlength="160"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/questionnaire/executive'); ?>" class="btn btn-danger">
	  		...
	  		bootbox.dialog({
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      className: "btn btn-danger bigger-140",
	  		      callback: function() {
	  		    ...
	  		    cancel: {
	  		      ...
	  		      className: "btn btn-default bigger-140"
	  		    }
	  		  }
	  		});
	  	});
