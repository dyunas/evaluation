		    ...
		    <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/questionnaire/employee/new'); ?>">
			            ...
			            <tr>
			              ...
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
						      <a class="blue" href="<?php echo site_url('admin_panel/questionnaire/employee/edit/'.$item->id); ?>">
						    ...
						    <div class="hidden-md hidden-lg">
							  <div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
								  <li>
								    <a href="<?php echo site_url('admin_panel/questionnaire/employee/edit/'.$item->id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
									  <span class="blue">
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		        ...
	  		        var link = "<?php echo site_url('admin_panel/questionnaire/employee/delete/"+id+"'); ?>";
