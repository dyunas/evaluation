	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/questionnaire/employee'); ?>">For Employee</a>
			</li>
			<li class="active">
			  New Question
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/questionnaire/employee/insert'), 'id="question-form" class="form-horizontal"'); ?>
				  ...
				  <div class="col-xs-12 col-sm-9">
					...
					<div class="clearfix form-actions">
					  <div class="col-md-offset-3 col-md-9">
						...
						<a href="<?php echo site_url('admin_panel/questionnaire/employee'); ?>" class="btn btn-danger">
