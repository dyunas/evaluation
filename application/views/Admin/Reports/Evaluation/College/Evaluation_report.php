	  ...
	  <div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
			  ...
			  <ul class="breadcrumb">
					...
					<li class="">
						<a href="<?php echo site_url('admin_panel/report/evaluation/college'); ?>">College</a>
					</li>
					<li class="active"><?php echo date('M d, Y', $date); ?></li>
			  </ul><!-- /.breadcrumb -->
			</div><!-- breadcrumbs -->
					  ...
					  <div>
					  	<div class="text-right">
					  		<a href="#" id="print" class="btn btn-white btn-danger btn-bold">
								...
								<a href="<?php echo site_url('admin_panel/report/evaluation/college'); ?>" class="btn btn-white btn-danger btn-bold">
