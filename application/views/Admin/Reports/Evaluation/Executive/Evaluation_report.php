	  ...
	  <div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
			  ...
			  <ul class="breadcrumb">
					...
					<li>
					  <a href="<?php echo site_url('admin_panel/report/evaluation/executive'); ?>">Executive</a>
					</li>
					<li class="active"><?php echo $evlee->emp_id; ?></li>
			  </ul><!-- /.breadcrumb -->
			</div><!-- breadcrumbs -->
					  ...
					  <div>
					  	<div class="text-right">
					  		<a href="#" id="print" class="btn btn-white btn-danger btn-bold">
								...
								<a href="<?php echo site_url('admin_panel/report/evaluation/executive'); ?>" class="btn btn-white btn-danger btn-bold">
					  	...
					  	<div id="printable">
					  		<h4>
					  			<small>
					  				...
					  				<span class="pull-right">Date: <?php echo date('F, Y', $date); ?></span><br/>
					  			</small>
					  		</h4>
