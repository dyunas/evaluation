<body class="no-skin">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		  	<div class="col-md-12 text-center">
		  		<button id="backup" class="btn btn-lg btn-primary"><span class="fa fa-lg fa-hdd-o"></span> Backup Database</button>
		  	</div>
		  </div>
		</div><!-- page-content -->
  ...
  <!-- basic scripts -->
	...
	$('#backup').click(function(e){
		window.location.href = "<?=site_url()?>Admin/Data_management/Backup/backup_database";
		e.PreventDefault;
	});
	  jQuery(function($) {
	  	/*---backup---*/
