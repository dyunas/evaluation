	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="active">Employee Records</li>
		  </ul><!-- /.breadcrumb -->
		</div><!-- breadcrumbs -->
		  ...
		  <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/employee_records/new'); ?>">
		      	    <i class="ace-icon fa fa-user-plus bigger-250 blue"></i>
		      	  </a>
		      	</div>
			            ...
			            <tr>
			              ...
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
			                  <a class="blue" href="<?php echo site_url('admin_panel/employee_records/'.$item->emp_id); ?>">
													<i class="ace-icon fa fa-search-plus bigger-130"></i>
											  </a>

										    <a class="blue" href="<?php echo site_url('admin_panel/employee_records/edit/'.$item->emp_id); ?>">
										      <i class="ace-icon fa fa-pencil bigger-130"></i>
										    </a>

										    <a href="javascript:();" class="red confirm_<?php echo $item->emp_id;?>" data-id="<?php echo $item->emp_id; ?>">
									    ...
									    <div class="hidden-md hidden-lg">
											  <div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												  <li>
												    <a href="<?php echo site_url('admin_panel/employee_records/'.$item->emp_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													  <span class="blue">
													    <i class="ace-icon fa fa-search-plus bigger-130"></i>
													  </span>
													</a>
												  ...
												  <li>
												    <a href="<?php echo site_url('admin_panel/employee_records/edit/'.$item->emp_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													  <span class="blue">
												  ...
												  <li>
												    <a href="javascript:();" class="red confirm_<?php echo $item->emp_id;?>" data-id="<?php echo $item->emp_id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
													  <span class="red">
  ...
  <!-- basic scripts -->
	...
	<script type="text/javascript">
	  jQuery(function($) {
	  	//Confirm Dialog
	  	<?php foreach($records as $item): ?>
	  	$(".confirm_<?php echo $item->emp_id; ?>").on(ace.click_event, function() {
	  		bootbox.dialog({
	  		  message: "Are you sure you want to delete this data <?php echo $item->emp_id; ?>?",
	  		  title: "Confirm",
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		      	var id = $(".confirm_<?php echo $item->emp_id;?>").attr('data-id');
