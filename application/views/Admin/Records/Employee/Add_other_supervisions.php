	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="active"><?php echo $evltr; ?></li>
		  </ul><!-- /.breadcrumb -->
		</div><!-- breadcrumbs -->
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		    	<?php echo form_open(site_url('admin_panel/employee_records/insert_other_sup/'.$evltr), 'id="supervision-form"'); ?>
						    ...
						    <table id="simple-table" class="table table-striped table-bordered">
						    	<thead>
								  ...
								  <tbody>
								  	...
								  	<tr>
									    <td class="col-xs-1 col-sm-1 center"><input type="checkbox" name="assignee[]" value="<?php echo $item->emp_id; ?>"></td>
									    <td class="col-xs-8 col-sm-8"><?php echo $item->fname.' '.$item->mname.' '.$item->lname; ?></td>
									    <td class="col-xs-3 col-sm-3"><?php echo $item->position_name; ?></td>
									  </tr>
										<?php endforeach; ?>
								  </tbody>
								</table><!-- table -->
								...
								<div class="clearfix form-actions">
								  <div class="col-md-offset-3 col-md-9">
								    <button class="btn btn-info" type="submit">
										...
										<a href="<?php echo site_url('admin_panel/employee_records/'.$evltr); ?>" class="btn btn-danger">
