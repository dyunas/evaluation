	...
	<div class="main-content">
	  <div class="main-content-inner">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/employee_records/insert'), 'id="employee-form" class="form-horizontal"'); ?>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="emp_id" name="emp_id" class="col-xs-10 col-sm-6" maxlength="10"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="position" name="position">
					  	...
					  	<option value="<?php echo $item->user_type; ?>"><?php echo $item->position_name; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="department" name="department">
					  	...
					  	<option value="<?php echo $item->dprtmnt_name; ?>"><?php echo $item->dprtmnt_name; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/employee_records'); ?>" class="btn btn-danger">
