	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/employee_records'); ?>">Employee Records</a>
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/employee_records/update'), 'id="employee-form" class="form-horizontal"'); ?>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="emp_id" name="emp_id" class="col-xs-10 col-sm-6" maxlength="10" value="<?php echo $edit->emp_id; ?>" readonly/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="fname" name="fname" class="col-xs-10 col-sm-6" maxlength="30" value="<?php echo $edit->fname; ?>"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="mname" name="mname" class="col-xs-10 col-sm-6" maxlength="30" value="<?php echo $edit->mname; ?>"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="lname" name="lname" class="col-xs-10 col-sm-6" maxlength="30" value="<?php echo $edit->lname; ?>"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="position" name="position">
					  	...
					  	<option value="<?php echo $item->position_name; ?>" <?php echo ($edit->position == $item->position_name) ? 'selected' : ''; ?>><?php echo $item->position_name; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="department" name="department">
					  	...
					  	<option value="<?php echo $item->dprtmnt_name; ?>" <?php echo ($edit->department == $item->dprtmnt_name) ? 'selected' : ''; ?>><?php echo $item->dprtmnt_name; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/employee_records/'.$edit->emp_id); ?>" class="btn btn-danger">
	  ...
	  jQuery(function($)
	  {
		...
		.on('actionclicked.fu.wizard' , function(e, info){
		  if(info.step == 1 && $validation) {
		    if(!$('#employee-form').valid()) e.preventDefault();
		  }
		});
		  ...
		  messages: {
			  emp_id: {
				  ...
				  minlength: "Please provide a valid Employee ID"
				},
				fname: {
