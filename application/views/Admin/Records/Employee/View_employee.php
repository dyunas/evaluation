<body class="no-skin">
	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="active"><?php echo $info->emp_id; ?></li>
		  </ul><!-- /.breadcrumb -->
		</div><!-- breadcrumbs -->
			  	    ...
			  	    <div id="profile" class="tab-pane fade in active">
			  	      <div class="row">
						  ...
						  <span class="profile-picture">
						    <?php if ($info->photo): ?>
						    	<img class="img-responsive" alt="" id="avatar2" src="<?php echo base_url('assets/uploads/profile/'.$info->photo); ?>" />
						  	<?php else: ?>
						  		<img class="img-responsive" alt="" id="avatar2" src="<?php echo base_url('assets/avatars/profile-pic.jpg'); ?>" />
						  	<?php endif; ?>
						  </span>

						  <div class="space space-4"></div>

						  <a href="<?php echo site_url('admin_panel/employee_records/edit/'.$info->emp_id); ?>" class="btn btn-sm btn-block btn-inverse">
						  	<i class="ace-icon fa fa-pencil bigger-120"></i>
						  	<span class="bigger-110"> Edit Record</span>
						  </a>

						  <a href="javascript:();" id="confirm" data-id="<?php echo $info->emp_id; ?>" class="btn btn-sm btn-block btn-danger">
							<i class="ace-icon fa fa-trash-o bigger-120"></i>
							<span class="bigger-110"> Delete</span>
						  </a>

						  <a href="<?php echo site_url('admin_panel/employee_records'); ?>" class="btn btn-sm btn-block btn-default">
						...
						<div id="details" class="col-xs-12 col-sm-9">
						  ...
						  <div class="profile-user-info">
							...
							<div class="profile-info-row">
							  ...
							  <div class="profile-info-value">
							    <span><?php echo $info->emp_id; ?></span>
							  </div>
							</div>
							...
							<div class="profile-info-row">
							  ...
							  <div class="profile-info-value">
							    <span><?php echo $info->position_name; ?></span>
							  </div>
							</div>
							...
							<div class="profile-info-row">
							  ...
							  <div class="profile-info-value">
							    <span><?php echo $info->department; ?></span>
							  </div>
							</div>
						  ...
						  <?php if($info->user_type == 4 OR $info->user_type == 5 OR $info->user_type == 7 OR $info->user_type == 12 OR $info->user_type == 13 OR $info->user_type == 17 OR $info->user_type == 8): ?>
								<!-- <div class="widget-box transparent"> -->
								  <!-- <div class="widget-header widget-header-small">
									...
									<div class="widget-toolbar action-buttons">
									  <a href="<?php echo site_url('admin_panel/employee_records/add_sup/'.$info->emp_id); ?>" class="blue">
								    ...
								    <div class="widget-main padding-8">
								      ...
								      <?php //foreach($supervisions as $sup): ?>
								      	<!-- <div class="profile-activity clearfix">
								      	  <div>
								      	  	<span><?php echo $sup->course.' - '.$sup->yr_lvl.' - '.$sup->section.' - '.$sup->subject; ?></span>
								      	  </div>
								      	  <div class="tools action-buttons">
														<a href="javascript:();" class="red sup_<?php echo $sup->emp_id; ?>" data-id="<?php echo $sup->id; ?>">
							...
							<?php //if($info->user_type == 2 OR $info->user_type == 3 OR $info->user_type == 4 OR $info->user_type == 5 OR $info->user_type == 6 OR $info->user_type == 7 OR $info->user_type == 9 OR $info->user_type == 12 OR $info->user_type == 13 OR $info->user_type == 17 OR $info->user_type == 8): ?>
								<div class="widget-box transparent">
								  <div class="widget-header widget-header-small">
								    <h4 class="widget-title blue smaller">
										  Peers
									...
									<div class="widget-toolbar action-buttons">
									  <a href="<?php echo site_url('admin_panel/employee_records/add_other_sup/'.$info->emp_id); ?>" class="blue">
									    <i class="ace-icon fa fa-plus"></i>
									  </a>
									  &nbsp;
									  <a href="#" data-action="reload">
								  ...
								  <div class="widget-body">
								    <div class="widget-main padding-8">
								      <div id="profile-feed-1" class="profile-feed">
								      <?php if($other_sup): ?>
								      <?php foreach($other_sup as $sup): ?>
								      	<div class="profile-activity clearfix">
								      	  <div>
								      	  	<?php echo $sup->fname.' '.$sup->mname.' '.$sup->lname; ?> - 
								      	  	<?php echo $sup->department; ?> - 
								      	  	<?php echo $sup->position_name; ?>
								      	  </div>

								      	  <div class="tools action-buttons">
														<a href="javascript:();" class="red other_sup_<?php echo $sup->emp_id; ?>" data-id="<?php echo $sup->emp_id; ?>">
															<i class="ace-icon fa fa-times bigger-125"></i>
														</a>
													</div>
								      	</div><!-- profile-activity -->
  ...
  <!-- basic scripts -->
	...
	<script type="text/javascript">
	  jQuery(function($) {
	  	//Other supervision confirm dialog
	  	<?php if($other_sup): ?>
	  		<?php foreach($other_sup as $sup): ?>
		  		$(".other_sup_<?php echo $sup->emp_id; ?>").on(ace.click_event, function() {
		  		bootbox.dialog({
		  		  ...
		  		  buttons: {
		  		    success: {
		  		      ...
		  		      callback: function() {
		  		      	var id = $(".other_sup_<?php echo $sup->emp_id; ?>").attr('data-id');
		  		        var link = "<?php echo site_url('admin_panel/employee_records/other_sup/delete/'.$info->emp_id.'/"+id+"'); ?>";
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		        ...
	  		        var link = "<?php echo site_url('admin_panel/employee_records/delete/"+id+"'); ?>";
