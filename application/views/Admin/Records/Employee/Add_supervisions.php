	...
	<div class="main-content">
	  <div class="main-content-inner">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		    	<?php echo form_open(site_url('admin_panel/employee_records/insert_sup/'.$info->emp_id), 'id="supervision-form"'); ?>
		        ...
		        <div class="widget-body">
		          <div class="widget-main no-padding">
						    <table id="simple-table" class="table table-striped table-bordered">
								  <tbody>
								  	<tr>
								  	<?php if($info->user_type == 12 OR $info->user_type == 17 OR $info->user_type == 5 OR $info->user_type == 4 OR $info->user_type == 7): ?>
								  	  <td>Course</td>
								  	  <td>
								  	  	<select name="course[]">
								  	  	  <option></option>
								  	  ...
								  	  <td>
								  	  	<select name="subject[]">
								  	  	  ...
								  	  	  <?php foreach($subjects as $item): ?>
								  	  	    <option value="<?php echo $item->subj_code; ?>"><?php echo $item->subj_code; ?></option>
								  	  	  <?php endforeach; ?>
								  	  	</select>
								  	  </td>
								  	<?php else: ?>
								...
								<div class="clearfix form-actions">
								  <div class="col-md-offset-3 col-md-9">
								    <button class="btn btn-info" type="submit">
										...
										<a href="<?php echo site_url('admin_panel/employee_records/'.$info->emp_id); ?>" class="btn btn-danger">
