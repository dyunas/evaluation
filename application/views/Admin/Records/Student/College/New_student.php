<body class="no-skin">
	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/student_records/college;'); ?>"></a>
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/student_records/college/insert'), 'id="student-form" class="form-horizontal"'); ?>
				...
				<input type="hidden" id="user_type" name="user_type" value="<?php echo $type->user_type; ?>" />
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="stud_id" name="stud_id" class="col-xs-10 col-sm-6" maxlength="10"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="fname" name="fname" class="col-xs-10 col-sm-6" maxlength="30"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="mname" name="mname" class="col-xs-10 col-sm-6" maxlength="30"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="lname" name="lname" class="col-xs-10 col-sm-6" maxlength="30"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="course" name="course">
					  	...
					  	<option value="<?php echo $item->course_code; ?>"><?php echo $item->course; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/student_records/college'); ?>" class="btn btn-danger">
  ...
  <!-- basic scripts -->
	...
	<script type="text/javascript">
	  jQuery(function($)
	  {
	  	$('#yr_lvl').change(function() {
	  		var yr_lvl = $(this).val(); // get the current option's value
	  		var dataString = yr_lvl;

	  		if (dataString)
	  		{
	  			$.get("<?php echo site_url('admin_panel/student_records/section');?>",{code:dataString},function(data){
	    			$('#result').html(data);
	    		});
	  		}
	  		else
		...
		// });
		  ...
		  messages: {
		    uname: {
			  ...
			  minlength: "Username should be at least 6 characters long"
			},
			pword: {
