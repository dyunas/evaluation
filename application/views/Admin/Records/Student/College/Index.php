		  ...
		  <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/student_records/college/new'); ?>">
			      ...
			      <tbody>
			        <?php if($records): ?>
			          <?php foreach($records as $item): ?>
			            <tr>
			              <td><?php echo $item->stud_id; ?></td>
			              <td><?php echo $item->lname.', '.$item->fname.' '.$item->mname; ?></td>
			              <td><?php echo $item->course; ?></td>
			              <td><?php echo $item->yr_lvl; ?></td>
			              <td><?php echo $item->section; ?></td>
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
			                  <a class="blue" href="<?php echo site_url('admin_panel/student_records/college/'.$item->stud_id); ?>">
								<i class="ace-icon fa fa-search-plus bigger-130"></i>
							  </a>

						      <a class="blue" href="<?php echo site_url('admin_panel/student_records/college/edit/'.$item->stud_id); ?>">
						        <i class="ace-icon fa fa-pencil bigger-130"></i>
						      </a>

						      <a href="javascript:();" class="red confirm_<?php echo $item->id;?>" data-id="<?php echo $item->id; ?>">
						    ...
						    <div class="hidden-md hidden-lg">
							  <div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
								  <li>
								    <a href="<?php echo site_url('admin_panel/student_records/college/'.$item->stud_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
									  <span class="blue">
									    <i class="ace-icon fa fa-search-plus bigger-130"></i>
									  </span>
									</a>
								  ...
								  <li>
								    <a href="<?php echo site_url('admin_panel/student_records/college/edit/'.$item->stud_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
									  <span class="blue">
								  ...
								  <li>
								    <a href="javascript:();" class="red confirm_<?php echo $item->id;?>" data-id="<?php echo $item->id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
									  <span class="red">
