	...
	<div class="main-content">
	  <div class="main-content-inner">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/student_records/college/update'), 'id="student-form" class="form-horizontal"'); ?>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="course" name="course">
					  	...
					  	<option value="<?php echo $item->course_code; ?>" <?php echo ($edit->course == $item->course_code) ? 'selected' : '' ?>><?php echo $item->course; ?></option>
					    <?php endforeach; ?>
					  </select>
					</div>
				  </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="yr_lvl" name="yr_lvl">
					  	<option></option>
					  	<option value="1st year" <?php echo ($edit->yr_lvl == '1st year') ? 'selected' : '' ?>>1st year</option>
					  	<option value="2nd year" <?php echo ($edit->yr_lvl == '2nd year') ? 'selected' : '' ?>>2nd year</option>
					  	<option value="3rd year" <?php echo ($edit->yr_lvl == '3rd year') ? 'selected' : '' ?>>3rd year</option>
					  	<option value="4th year" <?php echo ($edit->yr_lvl == '4th year') ? 'selected' : '' ?>>4th year</option>
					  </select>
					</div>
				  </div>
				</div><!-- form-group -->
