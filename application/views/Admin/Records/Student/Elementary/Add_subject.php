	...
	<div class="main-content">
	  <div class="main-content-inner">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		    	<?php echo form_open(site_url('admin_panel/student_records/elem/insert_sub/'.$info->stud_id), 'id="supervision-form"'); ?>
								...
								<div class="clearfix form-actions">
								  <div class="col-md-offset-3 col-md-9">
								    <button class="btn btn-info" type="submit">
										...
										<a href="<?php echo site_url('admin_panel/student_records/elem/'.$info->stud_id); ?>" class="btn btn-danger">
