	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class=""><a href="<?php echo site_url('admin_panel/student_records/elem'); ?>">Elementary</a></li>
			  	  ...
			  	  <div class="tab-content no-border padding-24">
			  	    <div id="profile" class="tab-pane fade in active">
			  	      <div class="row">
						  ...
						  <a href="<?php echo site_url('admin_panel/student_records/elem/edit/'.$info->stud_id); ?>" class="btn btn-sm btn-block btn-inverse">
						  ...
						  <a href="<?php echo site_url('admin_panel/student_records/elem'); ?>" class="btn btn-sm btn-block btn-default">
						  	...
						  	<div class="widget-header widget-header-small">
								  <h4 class="widget-title blue smaller">
									...
									<div class="widget-toolbar action-buttons">
									  <a href="<?php echo site_url('admin_panel/student_records/elem/add_sub/'.$info->stud_id); ?>" class="blue">
			  		  ...
			  		  buttons: {
			  		    success: {
			  		      ...
			  		      callback: function() {
			  		        ...
			  		        var link = "<?php echo site_url('admin_panel/student_records/elem/del_sub/'.$info->stud_id.'/"+id+"/"+subj+"'); ?>";
