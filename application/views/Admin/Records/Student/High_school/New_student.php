	...
	<div class="main-content">
	  <div class="main-content-inner">
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/student_records/hs/insert'), 'id="student-form" class="form-horizontal"'); ?>
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/student_records/hs'); ?>" class="btn btn-danger">
