	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/student_records/hs'); ?>">High School</a>
			</li>
			<li class="active">
			  Edit Record
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      <?php echo form_open(site_url('admin_panel/student_records/hs/update'), 'id="student-form" class="form-horizontal"'); ?>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
					  ...
					  <select class="col-xs-10 col-sm-6" id="yr_lvl" name="yr_lvl">
					  	<option></option>
					  	<option value="Grade 7" <?php echo ($edit->yr_lvl == 'Grade 7') ? 'selected' : '' ?>>Grade 7</option>
					  	<option value="Grade 8" <?php echo ($edit->yr_lvl == 'Grade 8') ? 'selected' : '' ?>>Grade 8</option>
					  	<option value="Grade 9" <?php echo ($edit->yr_lvl == 'Grade 9') ? 'selected' : '' ?>>Grade 9</option>
					  	<option value="Grade 10" <?php echo ($edit->yr_lvl == 'Grade 10') ? 'selected' : '' ?>>Grade 10</option>
					  	<option value="Grade 11" <?php echo ($edit->yr_lvl == 'Grade 11') ? 'selected' : '' ?>>Grade 11</option>
					  	<option value="Grade 12" <?php echo ($edit->yr_lvl == 'Grade 12') ? 'selected' : '' ?>>Grade 12</option>
					  </select>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/student_records/hs/'.$edit->stud_id); ?>" class="btn btn-danger">
