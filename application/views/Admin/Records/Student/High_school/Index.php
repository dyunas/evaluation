		  ...
		  <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/student_records/hs/new'); ?>">
			            ...
			            <tr>
			              ...
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
			                  <a class="blue" href="<?php echo site_url('admin_panel/student_records/hs/'.$item->stud_id); ?>">
								<i class="ace-icon fa fa-search-plus bigger-130"></i>
							  </a>

						      <a class="blue" href="<?php echo site_url('admin_panel/student_records/hs/edit/'.$item->stud_id); ?>">
						    ...
						    <div class="hidden-md hidden-lg">
							  <div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
								  <li>
								    <a href="<?php echo site_url('admin_panel/student_records/hs/'.$item->stud_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
									  <span class="blue">
									    <i class="ace-icon fa fa-search-plus bigger-130"></i>
									  </span>
									</a>
								  ...
								  <li>
								    <a href="<?php echo site_url('admin_panel/student_records/hs/edit/'.$item->stud_id); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
									  <span class="blue">
