			  	  ...
			  	  <div class="tab-content no-border padding-24">
			  	    <div id="profile" class="tab-pane fade in active">
			  	      <div class="row">
						  ...
						  <a href="<?php echo site_url('admin_panel/student_records/hs/edit/'.$info->stud_id); ?>" class="btn btn-sm btn-block btn-inverse">
						  ...
						  <a href="<?php echo site_url('admin_panel/student_records/hs'); ?>" class="btn btn-sm btn-block btn-default">
						  	...
						  	<div class="widget-header widget-header-small">
								  <h4 class="widget-title blue smaller">
									...
									<div class="widget-toolbar action-buttons">
									  <a href="<?php echo site_url('admin_panel/student_records/hs/add_sub/'.$info->stud_id); ?>" class="blue">
			  		  ...
			  		  buttons: {
			  		    success: {
			  		      ...
			  		      callback: function() {
			  		        ...
			  		        var link = "<?php echo site_url('admin_panel/student_records/hs/del_sub/'.$info->stud_id.'/"+id+"/"+subj+"'); ?>";
