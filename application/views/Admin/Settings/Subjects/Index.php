		    ...
		    <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/settings/subjects/new'); ?>">
			      ...
			      <tbody>
			        <?php if($subjects): ?>
			          <?php foreach($subjects as $item): ?>
			            <tr>
			              <td><?php echo $item->subj_name; ?></td>
			              <td><?php echo $item->subj_code; ?></td>
			              <td><?php echo $item->for_level; ?></td>
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
									      <a class="blue" href="<?php echo site_url('admin_panel/settings/subjects/edit/'.$item->id); ?>">
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		        ...
	  		        var link = "<?php echo site_url('admin_panel/settings/subjects/delete/"+id+"'); ?>";
