		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/subjects/update/'.$subj->id), 'id="subjects-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
						  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="subj_name"> Subject Name: </label>

						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="subj_name" name="subj_name" class="col-xs-10 col-sm-10" value="<?php echo $subj->subj_name; ?>" maxlength="100"/>
								</div>
						  </div>
						</div><!-- form-group -->

						<div class="form-group">
						  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="subj_code"> Subject Code: </label>

						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="subj_code" name="subj_code" class="col-xs-2 col-sm-2" value="<?php echo $subj->subj_code; ?>" maxlength="10"/>
								</div>
						  </div>
						</div><!-- form-group -->

						<div class="form-group">
						  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="for_level"> For: </label>

						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <select id="for_level" name="for_level" class="col-xs-3 col-sm-3">
								  	<option></option>
								  	<option value="Elem" <?php echo ($subj->for_level == 'Elem') ? 'selected' : ''; ?>>Elementary</option>
								  	<option value="Jr. High" <?php echo ($subj->for_level == 'Jr. High') ? 'selected' : ''; ?>>Junior High</option>
								  	<option value="Sr. High" <?php echo ($subj->for_level == 'Sr. High') ? 'selected' : ''; ?>>Senior High</option>
								  	<option value="College" <?php echo ($subj->for_level == 'College') ? 'selected' : ''; ?>>College</option>
								  </select>
								</div>
						  </div>
						</div><!-- form-group -->
						...
						<div class="clearfix form-actions">
						  <div class="col-md-offset-3 col-md-9">
							...
							<a href="<?php echo site_url('admin_panel/settings/subjects'); ?>" class="btn btn-danger">
	  ...
	  jQuery(function($)
	  {
		...
		.on('actionclicked.fu.wizard' , function(e, info){
		  if(info.step == 1 && $validation) {
		    if(!$('#subjects-form').valid()) e.preventDefault();
		  }
		});
		  ...
		  messages: {
		    subj_name: "please specify a subject.",
		    subj_code: "please specify a subject code.",
		    for_level: "this field is required.",
		  },
