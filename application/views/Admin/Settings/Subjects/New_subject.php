		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/subjects/insert'), 'id="subjects-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
						  ...
						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="subj_name" name="subj_name" class="col-xs-10 col-sm-10" value="<?php echo $this->session->flashdata('subj_name'); ?>" maxlength="100"/>
								</div>
						  </div>
						</div><!-- form-group -->
						...
						<div class="form-group">
						  ...
						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="subj_code" name="subj_code" class="col-xs-2 col-sm-2" value="<?php echo $this->session->flashdata('subj_code'); ?>" maxlength="10"/>
								</div>
						  </div>
						</div><!-- form-group -->
						  ...
						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <select id="for_level" name="for_level" class="col-xs-3 col-sm-3">
								  	...
								  	<option value="Jr. High">Junior High</option>
								  	<option value="Sr. High">Senior High</option>
