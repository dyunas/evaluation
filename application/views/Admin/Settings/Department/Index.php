		    ...
		    <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/settings/department/new'); ?>">
			      ...
			      <tbody>
			        <?php if($department): ?>
			          <?php foreach($department as $item): ?>
			            <tr>
			              <td><?php echo $item->dprtmnt_name; ?></td>
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
									      <a class="blue" href="<?php echo site_url('admin_panel/settings/department/edit/'.$item->id); ?>">
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		        ...
	  		        var link = "<?php echo site_url('admin_panel/settings/department/delete/"+id+"'); ?>";
