		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/department/insert'), 'id="department-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
						  ...
						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="department" name="department" class="col-xs-10 col-sm-10" value="<?php echo $this->session->flashdata('department'); ?>" maxlength="100"/>
								</div>
						  </div>
						</div><!-- form-group -->
