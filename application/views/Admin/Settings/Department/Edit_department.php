	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/settings/department'); ?>">Department</a>
			</li>
			<li class="active"><?php echo $edit->dprtmnt_name; ?></li>
		  </ul><!-- /.breadcrumb -->
		</div><!-- breadcrumbs -->
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/department/update'), 'id="department-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
				  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="department"> Department Name: </label>

				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="department" name="department" class="col-xs-10 col-sm-10" value="<?php echo $edit->dprtmnt_name; ?>" maxlength="100"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/settings/department'); ?>" class="btn btn-danger">
	  ...
	  jQuery(function($)
	  {
		...
		.on('actionclicked.fu.wizard' , function(e, info){
		  if(info.step == 1 && $validation) {
		    if(!$('#department-form').valid()) e.preventDefault();
		  }
		});
		  ...
		  messages: {
		    department: "please specify a department.",
		  },
