		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/course/update'), 'id="course-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="course" name="course" class="col-xs-10 col-sm-10" value="<?php echo $edit->course; ?>" maxlength="100"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="course_code" name="course_code" class="col-xs-10 col-sm-3" value="<?php echo $edit->course_code; ?>" maxlength="5"/>
					</div>
				  </div>
				</div><!-- form-group -->
