	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li>
			  <a href="<?php echo site_url('admin_panel/settings/course'); ?>">Course</a>
			</li>
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/course/insert'), 'id="course-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
				  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="course"> Course Name: </label>

				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="course" name="course" class="col-xs-10 col-sm-10" value="<?php echo $this->session->flashdata('course'); ?>" maxlength="100"/>
					</div>
				  </div>
				</div><!-- form-group -->

				<div class="form-group">
				  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="course_code"> Course Code: </label>

				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="course_code" name="course_code" class="col-xs-10 col-sm-3" value="<?php echo $this->session->flashdata('course_code'); ?>" maxlength="5"/>
					</div>
				  </div>
				</div><!-- form-group -->
				...
				<div class="clearfix form-actions">
				  <div class="col-md-offset-3 col-md-9">
					...
					<a href="<?php echo site_url('admin_panel/settings/course'); ?>" class="btn btn-danger">
	  ...
	  jQuery(function($)
	  {
		...
		.on('actionclicked.fu.wizard' , function(e, info){
		  if(info.step == 1 && $validation) {
		    if(!$('#positions-form').valid()) e.preventDefault();
		  }
		});
		  ...
		  messages: {
		    course: "please specify a course.",
		    course_code: "please specify a course code."
		  },
