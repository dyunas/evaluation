		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/positions/insert'), 'id="positions-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
						  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="position"> Position Name: </label>

						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="position" name="position" class="col-xs-10 col-sm-10" value="<?php echo $this->session->flashdata('position'); ?>" maxlength="100"/>
								</div>
						  </div>
						</div><!-- form-group -->

						<div class="form-group">
						  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="position"> Position ID: </label>

						  <div class="col-xs-12 col-sm-9">
						  	<div class="clearfix">
								  <input type="text" id="user_type" name="user_type" class="col-xs-2 col-sm-2" value="<?php echo $this->session->flashdata('user_type'); ?>" maxlength="2"/>
								</div>
						  </div>
						</div><!-- form-group -->
						...
						<div class="clearfix form-actions">
						  <div class="col-md-offset-3 col-md-9">
							...
							<a href="<?php echo site_url('admin_panel/settings/positions'); ?>" class="btn btn-danger">
	...
	<script type="text/javascript">
	  jQuery(function($)
	  {
		...
		.on('actionclicked.fu.wizard' , function(e, info){
		  ...
		  messages: {
		    position: "please specify a position.",
		    user_type: "please specify a user type.",
		  },
