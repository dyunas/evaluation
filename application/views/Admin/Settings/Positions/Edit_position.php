	  ...
	  <div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
		  ...
		  <ul class="breadcrumb">
			...
			<li class="">
			  <a href="<?php echo site_url('admin_panel/settings/positions'); ?>">Positions</a>
			</li>
			<li class="active"><?php echo $edit->position_name; ?></li>
		  </ul><!-- /.breadcrumb -->
		</div><!-- breadcrumbs -->
		...
		<div class="page-content">
		  ...
		  <div class="row">
		    <div class="col-xs-12">
		      ...
		      <?php echo form_open(site_url('admin_panel/settings/positions/update'), 'id="positions-form" class="form-horizontal"'); ?>
		        ...
		        <div class="form-group">
				  ...
				  <div class="col-xs-12 col-sm-9">
				  	<div class="clearfix">
					  <input type="text" id="position" name="position" class="col-xs-10 col-sm-10" value="<?php echo $edit->position_name; ?>" maxlength="100"/>
					</div>
				  </div>
				</div><!-- form-group -->
