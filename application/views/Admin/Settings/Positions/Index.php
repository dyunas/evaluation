		    ...
		    <div class="col-xs-12">
		      ...
		      <div class="clearfix">
		      	<div class="pull-right">
		      	  <a href="<?php echo site_url('admin_panel/settings/positions/new'); ?>">
			            ...
			            <tr>
			              ...
			              <td>
			                <div class="hidden-sm hidden-xs action-buttons">
									      <a class="blue" href="<?php echo site_url('admin_panel/settings/positions/edit/'.$item->id); ?>">
	  		  ...
	  		  buttons: {
	  		    success: {
	  		      ...
	  		      callback: function() {
	  		        ...
	  		        var link = "<?php echo site_url('admin_panel/settings/positions/delete/"+id+"'); ?>";
