			...
			<div class="page-content">
			  ...
			  <div class="row">
			      ...
			      <?php endif; ?>
					  ...
					  <div class="row">
					  	<div class="col-xs-12">
					  		<?php echo form_open(site_url('executive/account_settings/change_pass/confirm'), 'id="password-form" class="form-horizontal"'); ?>
					  			...
					  			<div class="form-group">
									...
									<div class="clearfix form-actions">
									  <div class="col-md-offset-3 col-md-9">
										...
										<a href="<?php echo site_url('executive/dashboard'); ?>" class="btn btn-danger">
