			  ...
			  <div class="row">
			  	<div class="col-xs-12">
			  		<div class="text-right">
							<a href="<?php echo site_url('student/evaluation_logs'); ?>" class="btn btn-white btn-danger btn-bold">
			      ...
			      <table id="simple-table" class="table table-striped table-bordered table-hover">
			      	<thead>
			      		<tr>
			      			<th>Question</th>
			      			<th class="col-xs-1 col-xs-1 center">Rating</th>
			      			<th class="col-xs-4 col-xs-4">Remarks</th>
			      		</tr>
			      	</thead>
					  	<tbody>
				        <?php if($logs): ?>
				          ...
				          <tr>
				          	...
				          	<td class="center"><?php echo $item->remarks; ?></td>
				          </tr>
				        	<?php endforeach; ?>
				        <?php else: ?>
				          <tr>
