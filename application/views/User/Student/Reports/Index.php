			  ...
			  <div class="row">
			      ...
			      <table id="simple-table" class="table table-striped table-bordered table-hover">
			      	<thead>
			      		<tr>
			      			<th>Evaluaee</th>
			      			<th class="col-xs-2 col-xs-2 center">Subject</th>
			      			<th class="col-xs-3 col-xs-3 center">Date</th>
			      			<th class="col-xs-1 col-xs-1 center">Action</th>
			      		</tr>
			      	</thead>
					  	<tbody>
				        <?php if($logs): ?>
				          ...
				          <tr>
				          	<td><?php echo $item->fname.' '.$item->mname.' '.$item->lname; ?></td>
				          	<td class="center"><?php echo $item->subject; ?></td>
				          	<td class="center"><?php echo date('F d, Y', $item->evltn_dte); ?></td>
				          	<td class="center">
				          		<div class="hidden-sm hidden-xs action-buttons">
			                  <a class="blue" href="<?php echo site_url('student/evaluation_logs/'.$item->emp_id.'/'.$item->subject.'/'.$item->evltn_dte); ?>">
											  ...
											  <div class="inline pos-rel">
											    <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown" data-position="auto">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													  <li>
													    <a href="<?php echo site_url('student/evaluation_logs/'.$item->emp_id.'/'.$item->subject.'/'.$item->evltn_dte); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														  <span class="blue">
														    <i class="ace-icon fa fa-search-plus bigger-130"></i>
														  </span>
														</a>
