		    ...
		    <ul class="nav ace-nav">
		      ...
		      <li class="red">
		        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
		          ...
		          <?php endif; ?>							<span class="user-info">
							  <small>Welcome</small>
	  ...
	  <div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
			  ...
			  <ul class="breadcrumb">
					...
					<li class="">
						<a href="<?php echo site_url('student/evaluate'); ?>">Evaluate</a>
					</li>
			...
			<div class="page-content">
			  ...
			  <div class="row">
			      ...
			      <?php echo form_open(site_url('student/evaluate/preview/'.$emp_id.'/'.$subject), 'id="evaluation_form"'); ?>
			      <input type="hidden" name="emp_id" value="<?php echo $emp_info->emp_id; ?>">
			      <input type="hidden" name="evltr_id" value="<?php echo $stud_id; ?>">
			      <input type="hidden" name="subject" value="<?php echo $subject; ?>">
			      <input type="hidden" name="evltn_dte" value="<?php echo $evltn_date; ?>">
			      				...
			      				<tr>
			      					...
			      					<td class="col-xs-1 col-sm-1">
			      						<div class="form-group">
													<input name="box_<?php echo $qstn->id; ?>" class="col-xs-12 col-sm-12" type="text" maxlength="1"/>
												</div>
			      					</td>
			      					<td class="col-xs-4 col-sm-4">
			      						<div class="form-group">
													<input name="rem_<?php echo $qstn->id; ?>" class="col-xs-12 col-sm-12" type="text" maxlength="160"/>
												</div>
			      					</td>
			      				</tr>
			      			<?php endforeach; ?>
			      	...
			      	<div class="clearfix form-actions">
							  <div class="col-md-offset-3 col-md-9">
								...
								<a href="<?php echo site_url('student/evaluate'); ?>" class="btn btn-danger">
