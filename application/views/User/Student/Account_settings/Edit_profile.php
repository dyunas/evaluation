					  			...
					  			<ul class="nav nav-tabs padding-16">
									...
									<div class="tab-content profile-edit-tab-content">
										<div id="edit-info" class="tab-pane in active">
											...
											<?php echo form_open(site_url('student/account_settings/edit_profile/confirm'), 'id="edit-info-form" class="form-horizontal"'); ?>
								  			<input type="hidden" name="user_id" value="<?php echo $stud_id; ?>" />
								  			<div class="form-group">
												  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="opword"> Student ID: </label>

												  <div class="col-xs-12 col-sm-9">
												  	<div class="clearfix">
													  	<input type="text" id="stud_id" name="stud_id" class="col-xs-10 col-sm-6" value="<?php echo $stud_id; ?>" readonly/>
														</div>
												  </div>
												</div><!-- form-group -->
												...
												<?php if ($user_type == 15): ?>
													<div class="form-group">
													  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="course"> Course: </label>

													  <div class="col-xs-12 col-sm-9">
													  	<div class="clearfix">
														  <select class="col-xs-10 col-sm-6" id="course" name="course">
														  	<option></option>
														  	<?php foreach($courses as $item): ?>
														  	<option value="<?php echo $item->course_code; ?>" <?php echo ($course == $item->course) ? 'selected' : ''; ?>><?php echo $item->course; ?></option>
														    <?php endforeach; ?>
														  </select>
														</div>
													  </div>
												...
												<div class="form-group">
												  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="yr_lvl"> Year Level: </label>

												  <div class="col-xs-12 col-sm-9">
												  	<div class="clearfix">
													  <select class="col-xs-10 col-sm-6" id="yr_lvl" name="yr_lvl">
													  	<option></option>
													  	<?php if ($user_type == 15): ?>
													  	...
													  	<?php elseif($user_type == 16): ?>
													  		<option value="Grade 7" <?php echo ($yr_lvl == 'Grade 7') ? 'selected' : ''; ?>>Grade 7</option>
														  	<option value="Grade 8" <?php echo ($yr_lvl == 'Grade 8') ? 'selected' : ''; ?>>Grade 8</option>
														  	<option value="Grade 9" <?php echo ($yr_lvl == 'Grade 9') ? 'selected' : ''; ?>>Grade 9</option>
														  	<option value="Grade 10" <?php echo ($yr_lvl == 'Grade 10') ? 'selected' : ''; ?>>Grade 10</option>
														  	<option value="Grade 11" <?php echo ($yr_lvl == 'Grade 11') ? 'selected' : ''; ?>>Grade 11</option>
														  	<option value="Grade 12" <?php echo ($yr_lvl == 'Grade 12') ? 'selected' : ''; ?>>Grade 12</option>
														  <?php else: ?>
														  	<option value="Grade 1" <?php echo ($yr_lvl == 'Grade 1') ? 'selected' : ''; ?>>Grade 1</option>
														  	<option value="Grade 2" <?php echo ($yr_lvl == 'Grade 2') ? 'selected' : ''; ?>>Grade 2</option>
														  	<option value="Grade 3" <?php echo ($yr_lvl == 'Grade 3') ? 'selected' : ''; ?>>Grade 3</option>
														  	<option value="Grade 4" <?php echo ($yr_lvl == 'Grade 4') ? 'selected' : ''; ?>>Grade 4</option>
														  	<option value="Grade 5" <?php echo ($yr_lvl == 'Grade 5') ? 'selected' : ''; ?>>Grade 5</option>
														  	<option value="Grade 6" <?php echo ($yr_lvl == 'Grade 6') ? 'selected' : ''; ?>>Grade 6</option>	
														  <?php endif; ?>
													  </select>
													</div>
												  </div>
												...
												<div class="form-group">
												  ...
												  <div class="col-xs-12 col-sm-9">
													  ...
													  <select class="col-xs-10 col-sm-6" id="section" name="section">
													  	<option></option>
													  	<option value="Section 1" <?php echo ($section == 'Section 1') ? 'selected' : ''; ?>>Section 1</option>
													  	<option value="Section 2" <?php echo ($section == 'Section 2') ? 'selected' : ''; ?>>Section 2</option>
													  	<option value="Section 3" <?php echo ($section == 'Section 3') ? 'selected' : ''; ?>>Section 3</option>
													  	<option value="Section 4" <?php echo ($section == 'Section 4') ? 'selected' : ''; ?>>Section 4</option>
													  </select>
													</div>
												  </div>
												</div><!-- form-group -->
												...
												<div class="clearfix form-actions">
												  <div class="col-md-offset-3 col-md-9">
													...
													<a href="<?php echo site_url('student/dashboard'); ?>" class="btn btn-danger">
										...
										<div id="edit-photo" class="tab-pane in">
											...
											<?php echo form_open_multipart(site_url('student/account_settings/edit_picture/confirm'), 'id="edit-photo-form" class="form-horizontal"'); ?>
												<div class="row">
													<div class="form-group">
										...
										<div id="change-pw" class="tab-pane in">
											...
											<?php echo form_open(site_url('student/account_settings/change_pass/confirm'), 'id="change-pw-form" class="form-horizontal"'); ?>
												<input type="hidden" name="user_id" value="<?php echo $stud_id; ?>" />
								  			<div class="form-group">
