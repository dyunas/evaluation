	  ...
	  <div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
			  ...
			  <ul class="breadcrumb">
					...
					<li class="">
						<a href="<?php echo site_url('employee/evaluate'); ?>">Evaluate</a>
					</li>
			...
			<div class="page-content">
			  ...
			  <div class="row">
			      ...
			      <?php echo form_open(site_url('employee/evaluate/preview/'.$emp_id), 'id="evaluation_form"'); ?>
			      ...
			      <input type="hidden" name="evltn_dte" value="<?php echo $evltn_date; ?>">
			      	...
			      	<div class="clearfix form-actions">
							  <div class="col-md-offset-3 col-md-9">
								...
								<a href="<?php echo site_url('employee/evaluate'); ?>" class="btn btn-danger">
