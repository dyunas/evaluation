	  ...
	  try{ace.settings.check('navbar' , 'fixed')}catch(e){}
		...
		<div class="navbar-container" id="navbar-container">
		  ...
		  <div class="navbar-header pull-left">
		    <a href="<?php echo site_url('employee/dashboard'); ?>" class="navbar-brand">
				  <small>
					  			...
					  			<ul class="nav nav-tabs padding-16">
									...
									<div class="tab-content profile-edit-tab-content">
										<div id="edit-info" class="tab-pane in active">
											...
											<?php echo form_open(site_url('employee/account_settings/edit_profile/confirm'), 'id="edit-info-form" class="form-horizontal"'); ?>
								  			<input type="hidden" name="user_id" value="<?php echo $emp_id; ?>" />
								  			<div class="form-group">
												  <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="opword"> Employee ID: </label>
										...
										<div id="edit-photo" class="tab-pane in">
											...
											<?php echo form_open_multipart(site_url('employee/account_settings/edit_picture/confirm'), 'id="edit-photo-form" class="form-horizontal"'); ?>
												<div class="row">
													<div class="form-group">
										...
										<div id="change-pw" class="tab-pane in">
											...
											<?php echo form_open(site_url('employee/account_settings/change_pass/confirm'), 'id="change-pw-form" class="form-horizontal"'); ?>
												<input type="hidden" name="user_id" value="<?php echo $emp_id; ?>" />
								  			<div class="form-group">
