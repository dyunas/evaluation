			      ...
			      <?php if($pword == '8d53f06c37248ba47128d1b304dc8704'): ?>
			      	<div class="alert alert-warning">
			      		...
			      		<span>You are currently using system provided password, security of your account is not guaranteed. 
			      			However, your can change you password <a href="<?php echo site_url('employee/account_settings/change_pass'); ?>">here.</a></span>
			      	</div>
			   		<?php endif; ?>
					  	    ...
					  	    <div id="profile" class="tab-pane fade in active">
					  	      <div class="row">
					  	      	<div class="col-xs-12 col-sm-3 center">
											  ...
											  <a href="<?php echo site_url('employee/account_settings/edit_profile'); ?>" class="btn btn-sm btn-block btn-inverse">
