			      ...
			      <?php endif; ?>
					  ...
					  <table id="simple-table" class="table table-striped table-bordered table-hover">
					  	<thead>
					  		<tr>
					  			<th>Evaluaee</th>
					  			<th class="col-xs-3 col-sm-3 center">Date</th>
					  			<th class="col-xs-2 col-sm-2 center">Action</th>
					  		</tr>
					  	</thead>
					  	<tbody>
				        <?php if($logs): ?>
				          ...
				          <tr>
				        		...
				        		<td class="center"><?php echo date('F, Y', $item->evltn_dte); ?></td>
				        		<td class="center">
				        			<div class="hidden-sm hidden-xs action-buttons">
			                  <a class="blue" href="<?php echo site_url('employee/evaluation_logs/'.$item->emp_id.'/'.$item->evltn_dte); ?>">
											  ...
											  <div class="inline pos-rel">
											    <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown" data-position="auto">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													  <li>
													    <a href="<?php echo site_url('executive/evaluation_logs/'.$item->emp_id.'/'.$item->evltn_dte); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														  <span class="blue">
														    <i class="ace-icon fa fa-search-plus bigger-130"></i>
														  </span>
														</a>
